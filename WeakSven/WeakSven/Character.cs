...
namespace WeakSven
{
    class Character : Entity
    {
        ...
        public const float Y_SPEED = .75f;
        protected Vector2 CharSpeed = new Vector2(X_SPEED, Y_SPEED);
        ...
        public Character() : base() { CharSpeed = new Vector2(X_SPEED, Y_SPEED); }
        public Character(string name) : base(name) { CharSpeed = new Vector2(X_SPEED, Y_SPEED); }
